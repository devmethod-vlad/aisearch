...
class KnowledgeFeedback(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "search_request_id",
            "question_id",
            name="unique_knowledge_feedback_request_question",
        ),
        Index(
            "idx_knowledge_feedback_created_at_asc",
            "created_at",
            postgresql_using="btree",
            postgresql_ops={"created_at": "ASC"},
        ),
        Index(
            "idx_knowledge_feedback_created_at_desc",
            "created_at",
            postgresql_using="btree",
            postgresql_ops={"created_at": "DESC"},
        ),
        Index(
            "idx_knowledge_feedback_modified_at_asc",
            "modified_at",
            postgresql_using="btree",
            postgresql_ops={"modified_at": "ASC"},
        ),
        Index(
            "idx_knowledge_feedback_modified_at_desc",
            "modified_at",
            postgresql_using="btree",
            postgresql_ops={"modified_at": "DESC"},
        ),
        Index(
            "idx_knowledge_feedback_search_request_id",
            "search_request_id",
            postgresql_using="btree",
        ),
        Index(
            "idx_knowledge_feedback_question_id",
            "question_id",
            postgresql_using="btree",
        ),
        Index(
            "idx_knowledge_feedback_source",
            "source",
            postgresql_using="btree",
        ),
        Index(
            "idx_knowledge_feedback_comment_gin",
            "comment",
            postgresql_using="gin",
            postgresql_ops={"comment": "gin_trgm_ops"},
        ),
        Index(
            "idx_knowledge_feedback_id_search_request_id",
            "id",
            "search_request_id",
            postgresql_using="btree",
        ),
        Index(
            "idx_knowledge_feedback_search_request_id_question_id",
            "search_request_id",
            "question_id",
            postgresql_using="btree",
        ),
